...
return [
    ...
    | pela classe de validação. Algumas dessas regras possuem versões múltiplas, 
    | como as regras de tamanho. Fique à vontade para personalizar cada uma 
    ...
    */
    ...
    | Isso facilita a definição de uma linha de idioma personalizada para 
    ...
    */
    ...
    'custom' => [
        'nome-atributo' => [
            'nome-regra' => 'mensagem-personalizada',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para substituir o marcador de
    | posição de atributo por algo mais amigável, como "Endereço de E-Mail"
    | em vez de "email". Isso ajuda a tornar a mensagem mais expressiva.
    |
    */
